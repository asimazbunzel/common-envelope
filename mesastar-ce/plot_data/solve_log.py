...
def make_iter_plot(name, dir=join('.', 'solve_logs'), 
...
if __name__ == '__main__':
    for name in ['corr_lnd', 'corr_lnR', 'corr_lnT', 'corr_lum', 'corr_u']:  # 'corr_ln_cvpv0'
        fig = make_iter_plot(name, min_zone=1, max_zone=None)
